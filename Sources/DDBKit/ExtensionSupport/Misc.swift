...
public extension DDBKitExtension {
  
  var logger: Logger {
    Logger(label: "Extension[\(type(of: self))]")
  }
...
extension DDBKitExtension {
  @inlinable
  func handleAsync(event: Gateway.Event) async { // swiftlint:disable:this function_body_length cyclomatic_complexity
    do {
