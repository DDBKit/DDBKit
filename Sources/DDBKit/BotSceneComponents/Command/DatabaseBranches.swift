...
public struct DatabaseBranches {
  ...
  public func user<Model: DatabaseModel>(ofType type: Model.Type) throws -> Database.FetchRequest<Model> {
  ...
  /// - Parameter type: Model Type
  /// - Returns: FetchRequest
  public func member<Model: DatabaseModel>(ofType type: Model.Type) throws -> Database.FetchRequest<Model> {
  ...
  /// - Parameter type: Model Type
  /// - Returns: FetchRequest
  public func guild<Model: DatabaseModel>(ofType type: Model.Type) throws -> Database.FetchRequest<Model> {
  ...
  /// - Parameter type: Model Type
  /// - Returns: FetchRequest
  public func channel<Model: DatabaseModel>(ofType type: Model.Type) throws -> Database.FetchRequest<Model> {
