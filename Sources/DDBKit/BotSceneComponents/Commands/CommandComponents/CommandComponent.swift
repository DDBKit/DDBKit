...
public struct Command: BaseCommand, _ExtensibleCommand, IdentifiableCommand, LocalisedThrowable {
  ...
  @_spi(Extensions) public var componentReceives:
    [String: [@Sendable (InteractionExtras) async throws -> Void]] = [:]
  ...
  public init(
    _ commandName: String, action: @Sendable @escaping (InteractionExtras) async throws -> Void
  ) {
