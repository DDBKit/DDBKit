...
extension ChannelMenu {
  ...
  /// Set the types of specifiable channels.
  /// - Parameter types: Channel types
  public func types(_ types: [DiscordChannel.Kind]) -> Self {
    var copy = self
    copy.object.channel_types = types
    return copy
  }
