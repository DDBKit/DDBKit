...
public struct StringMenu: _MessageComponentsActionRowComponent {
  ...
  public init(
    ...
    @GenericBuilder<StringMenuOption> _ options: () -> GenericTuple<StringMenuOption>
  ) {
    self.object = .init(
      custom_id: "",
...
extension StringMenuOption {
  ...
  public func emoji(_ emoji: Emoji) -> Self {
    var copy = self
  ...
  public func `default`(_ bool: Bool) -> Self {
    var copy = self
