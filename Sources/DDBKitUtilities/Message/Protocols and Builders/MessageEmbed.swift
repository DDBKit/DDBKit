...
public extension MessageEmbed {
  ...
  func setAuthor(_ name: String, url: String? = nil, icon_url: DynamicURL? = nil) -> Self { var e = self; e.author = Embed.Author(name: name, url: url, icon_url: icon_url); return e }
}
