...
public actor BucketRatelimiting: DDBKitExtension {
  ...
  private func getBucketKey(guildId: GuildSnowflake?, userId: UserSnowflake, command: String)
    -> String
  {
  ...
  public func ratelimitChecked(guildId: GuildSnowflake?, userId: UserSnowflake, command: String)
    async throws
  {
